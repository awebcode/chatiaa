          ...
          <div className="container mx-auto flex items-center flex-col justify-center h-[60vh]">
            <div className="flex flex-col p-8 rounded-lg shadow-md max-w-lg">
                ...
                <div className="relative  p-[2px] h-8 w-8 md:h-10 md:w-10 ring md:ring-2 ring-violet-500 rounded-full">
                  ...
                  <span
                    className={`absolute bottom-0 -right-1 rounded-full  p-[6px] ${
                      onlineUsers.some((u) => u.id === user?._id)
                        ? "bg-green-500"
                        : "bg-rose-500"
                    }`}
                  ></span>
              ...
              <div className="flex items-center justify-center mt-8 space-x-4">
                {/* Video Icon */}
                <FaVideo className="text-3xl text-blue-500 cursor-pointer hover:text-blue-700" />

                {/* Audio Icon */}
                <FaMicrophone className="text-3xl text-green-500 cursor-pointer hover:text-green-700" />

                {/* Chat Icon */}
                <FaComments className="text-3xl text-purple-500 cursor-pointer hover:text-purple-700" />
              </div>
            </div>
          </div>
        )}
